...
public interface AdmissionService {
    ...
    AdmissionResponseDto createAdmission(
            AdmissionRequestDto requestDto
    );

    AdmissionResponseDto getAdmissionById(
            String admissionId
    );

    List<AdmissionResponseDto> getAllAdmissions();

    List<AdmissionResponseDto> getAdmissionsByPatient(
            String patientId
    );

    AdmissionResponseDto updateAdmission(
            String admissionId,
            AdmissionRequestDto requestDto
    );

    AdmissionResponseDto dischargePatient(
            String admissionId
    );
